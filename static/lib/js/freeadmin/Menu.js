define([
    ...
    var Menu = declare("freeadmin.Menu", [], {
        ...
        /*Stackup Change  implement Reboot and Shutdown option on Menubar */
        openRebootScreen: function() {
           ...
           var opened = false;
            ...
            if(opened != true) {
                ...
                openurl = this.urlReboot;

                var pane = new ContentPane({
                    title: gettext('Rebooting the system...'),
                    closable: false,
                    href: openurl,
                });
                p.addChild(pane);
        ...
        openShutdownScreen: function() {
            ...
            if(opened != true) {
                ...
                openurl = this.urlShutdown;

                var pane = new ContentPane({
                    title: gettext('Shutingdown the system...'),
                    closable: false,
                    href: openurl,
                });
                p.addChild(pane);
